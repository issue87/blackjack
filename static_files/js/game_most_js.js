...
CardValues = {0:2,1:3,2:4,3:5,4:6,5:7,6:8,7:9,8:10,9:10,10:10,11:10,12:11};
        ...
        function initGame(){
            ...
            gameControlObjects.push(new GameControlGroup("#gameControlBet", 425, 270, 867, 68));
            ...
            gameControlObjects.push(new GameControlGroup(".menuControl", 0, 650, undefined, undefined));
            gameControlObjects.push(new GameControlGroup("#userName", 90, 15, 120, undefined));
            ...
            function resizeCanvas(){
                ...
                if (screen.availWidth/initialCanvasWidth < screen.availHeight/initialCanvasHeight){
                    ...
                    canvasHeight = screen.availHeight * 0.9;
                    //canvasWidth = (window.innerHeight/initialCanvasHeight) * initialCanvasWidth;
                    canvasWidth = (screen.availHeight * 0.9/initialCanvasHeight) * initialCanvasWidth;
                };
                ...
                const newFontSize = 20 * canvasScaleRatio;
                const nodes = document.querySelectorAll(".menuItem, .menuButton, #userName, #beforeLoad");
            ...
            var detectLoading = function (){
                 ...
                 if (images == 6){
                    ...
                    beforeLoad.style.visibility = "hidden";
                    resizeCanvas();
                 };
            };
            ...
            cardsImage.src = "static/images/Small_Cards.jpeg";
